...
function update_canvas()
{
   ...
   document.getElementById("sketch_to_be_drawn").innerHTML = quick_draw_data_set[random_number];
}
...
function gotResult(error, results)
{
    ...
    else
    {
        ...
        document.getElementById("confidence").innerHTML = per.toFixed(2)+" % ";
    }
}
...
function check_sketch()
{
   ...
   if(time_check == "completed" || answer_hold == "set")
   {
      time_check = "";
      answer_hold = "";
      update_canvas();
